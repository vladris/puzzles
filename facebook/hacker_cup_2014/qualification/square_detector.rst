...
You want to write an image detection system that is able to recognize different
geometric shapes. In the first version of the system you settled with just
being able to detect filled squares on a grid.
...
by `YES` or `NO` depending on whether or not all the black cells form a
...
outside of the square. Case 3 shows a square not filled inside. And case 4 is a
...
`View online <https://www.facebook.com/hackercup/problems.php?pid=318555664954399&round=598486203541358>`_.
